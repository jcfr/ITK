...
#                exorting the "itkLoad" symbol and available in directory
...
# -------------------------------------------------
#
# For each factory types (Image, Transform, ...), a registration manager header
...
# by the compiler accross all translation units.
#
...
# registered globally and available accross translation units.
#
# The file formats associated with each factory types are hard-coded as
# a list in CMake variable named after `LIST_OF_<factory_type>IO_FORMATS`.
#
#
...
# -----------------------------
#
# Setting variable `ITK_NO_IO_FACTORY_REGISTER_MANAGER` to ` prior calling
...
#
#  * the function is unique and consistently names for each IO factory. The
#    current naming convention is an implementation details and is not part
...
# directory properties, including external project (themselve including ITK)
