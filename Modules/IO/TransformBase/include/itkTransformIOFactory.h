...
extern template class ITKIOTransformBase_EXPORT TransformIOFactoryTemplate< double >;
extern template class ITKIOTransformBase_EXPORT TransformIOFactoryTemplate< float >;
#endif
