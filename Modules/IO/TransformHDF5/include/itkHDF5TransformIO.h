...
extern template class ITKIOTransformHDF5_EXPORT HDF5TransformIOTemplate< double >;
extern template class ITKIOTransformHDF5_EXPORT HDF5TransformIOTemplate< float >;
#endif
